<div class="row">
    ...
    <div class="col-md-6 col-12 mb-3">
        <x-dashboard.input-group type="text" wire:model.defer="form.email" name="form.email"
            :title="trans('table.columns.email')" />
    </div>

    <div class="col-md-6 col-12 mb-3">
        <x-dashboard.input-group type="number" wire:model.defer="form.phone" name="form.phone"
    ...
    <div class="col-md-6 col-12 mb-3">
        <x-dashboard.input-group type="number" wire:model.defer="form.number_of_branches" name="form.number_of_branches"
            :title="trans('table.columns.number of branches')" />
    </div>
