<div>
    ...
    <ul class="p-0 m-0 mx-4 mx-md-0 px-md-6">
        ...
        @php
            $currentUser = $user->id === $corp?->user_id;
        @endphp
            <li class="d-flex flex-wrap mb-4">
                ...
                <div class="d-flex justify-content-between flex-grow-1">
                    ...
                    <div class="dropdown">
                        <button type="button" wire:click="assign({{$user}})" class="btn btn-text-{{$currentUser ? 'secondary' : 'primary'}}  p-2 text-{{$currentUser ? 'secondary' : 'primary'}}">
