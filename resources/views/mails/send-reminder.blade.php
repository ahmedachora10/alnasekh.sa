<x-mail-layout>
    ...
    <div style="padding:20px 30px; background-color: white; font-size: 13px;">
        <span style="display: block; margin-bottom: 6px; color: #34221e; font-weight:700; text-align:right">
   ...
   s83.478,37.446,83.478,83.478C339.478,229.684,302.032,267.13,256,267.13z" />
        ...
        <span style="display: block; color: #34221e; font-weight:700; text-align:right">
            ...
            <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" style="position: relative; top: 3px;" width="12px"
                height="100%" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
                <g>
