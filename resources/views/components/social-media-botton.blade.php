...
@if (setting($key))
    <a href="{{ setting($key) }}" {{ $attributes }} style="border:0px; font-size: 1.5rem; color:white; padding: 0 10px">
        ...
        <img src="{{ $message->embed(public_path() . '/assets/icons/' . $key . '.svg') }}" type="image/svg+xml"
                ...
                <svg fill="#fff" height="800px" width="800px" version="1.1" id="XMLID_3_"
                    ...
                    <g id="social-youtube">
                        <g id="Lozenge">
                            <g>
                                <path
                                    d="M23.7,7.4c0,0-0.3-1.5-0.9-2.3c-0.9-0.9-2-0.8-2.4-0.9C17.1,4,12,4,12,4l0,0c0,0-5.1,0-8.4,0.2c-0.4,0.1-1.5,0.1-2.4,1
